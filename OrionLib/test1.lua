...
function OrionLib:Keysystem(Config)
    Config = Config or {}
    Config.Title = Config.Title or "Key System"
    Config.KeyVaild = Config.KeyVaild or {}
    ...
    local KeyMain = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(25, 25, 25), 0, 10), {
        Size = UDim2.new(0, 370, 0, 200),
        Position = UDim2.new(0.5, -183, 0.5, -116),
    }), {
        AddThemeObject(SetProps(MakeElement("Frame"), {
            Size = UDim2.new(0, 370, 0, 2),
            Position = UDim2.new(0, 0, 0.2, 0),
        }), "Second"),

        AddThemeObject(SetProps(MakeElement("TextLabel"), {
            Size = UDim2.new(0, 370, 0, 50),
        ...
        AddThemeObject(SetProps(MakeElement("RoundFrame", Color3.fromRGB(32, 32, 32), 0, 7), {
            Size = UDim2.new(0, 35, 0, 30),
            Position = UDim2.new(0, 320, 0, 5),
        }), "Button"),

        AddThemeObject(SetProps(MakeElement("TextButton"), {
        ...
        AddThemeObject(SetProps(MakeElement("RoundFrame", Color3.fromRGB(32, 32, 32), 0, 5), {
            Size = UDim2.new(0.3, 0, 0, 33),
            Position = UDim2.new(0.5, 40, 0.5, 30),
        }), "CheckFrame"),

        AddThemeObject(SetProps(MakeElement("ImageLabel"), {
            Size = UDim2.new(0, 20, 0, 20),
            Position = UDim2.new(0, 80, 0, 7),
    ...
    local textBox = KeyMain.Input
    local checkButton = KeyMain.CheckButton

    checkButton.MouseButton1Click:Connect(function()
        local userInput = textBox.Text
        if self:ValidateKey(userInput, Config.KeyVaild) then
            gui:Destroy()
            print("vaild Key")
            return true
        else
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Key = WindowConfig.Key or false
	OrionLib.Folder = WindowConfig.ConfigFolder
	OrionLib.SaveCfg = WindowConfig.SaveConfig
	

if WindowConfig.Key then
        local isKeyValid = self:Keysystem({
            Title = "Nhập Khóa",
            KeyVaild = {"anything", "yourKey1", "yourKey2"}
        })

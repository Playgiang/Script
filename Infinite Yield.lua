...
local DELTA = {}
DELTA["Ui"] = Instance.new("ScreenGui", game:GetService("CoreGui"))
DELTA["Ui"].Name = "infiniteyieldIcon"

DELTA["DaIcon"] = Instance.new("ImageButton", DELTA["Ui"])
DELTA["DaIcon"].Size = UDim2.new(0,45,0,45)
DELTA["DaIcon"].Position = UDim2.new(.001,0,0.5,0)
DELTA["DaIcon"].Draggable = true
DELTA["DaIcon"].Image = "rbxassetid://1352543873"
DELTA["DaIcon"].BackgroundColor3 = Color3.fromRGB(17, 36, 66)
